...
- (id)initWithRootViewController:(UIViewController*) controller {
    if ((self = [super init])) {
        ...
        SampleAppLeftMenuViewController *  mvc =[[SampleAppLeftMenuViewController alloc] initWithNibName:@"SampleAppLeftMenuViewController" bundle:nil];
