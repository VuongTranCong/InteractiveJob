...
#import "ImageTargetsResultView.h"
#import "Texture.h"
...
@interface ImageTargetsResultView (PrivateMethods)
...
@implementation ImageTargetsResultView
...
- (void)renderFrameQCAR
{
    ...
    for (int i = 0; i < state.getNumTrackableResults(); ++i) {
        ...
        [[AppController getInstance] foundObjectWithName:[[[NSString alloc] initWithUTF8String:trackable.getName()] autorelease]];
