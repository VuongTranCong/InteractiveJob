...
{
    // Create the EAGLView
    eaglView = [[ImageTargetsResultView alloc] initWithFrame:viewFrame appSession:vapp];
...
- (bool) doLoadTrackersData {
    dataSetStonesAndChips = [self loadObjectTrackerDataSet:@"Company.xml"];
    dataSetTarmac = [self loadObjectTrackerDataSet:@"Company.xml"];
